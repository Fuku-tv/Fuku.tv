...
const Privacy = () => (
  <div>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          Agreement) refers to Good Fortune Games LLC, New Hampshire.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Fuku TV, accessible from{' '}
          <a href="https://fuku.tv" rel="external nofollow noopener noreferrer" target="_blank">
            https://fuku.tv
          </a>
        </p>
      </li>
    ...
    <p>
      ...
      You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies here:{' '}
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          as a mobile application&apos;s push notifications regarding updates or informative communications related to the functionalities, products
    ...
    <ul>
      <li>By email: support@fuku.tv</li>
    </ul>
  </div>
);
