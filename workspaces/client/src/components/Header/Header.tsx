    ...
    <>
      <header>
        <div className="header-inner-wrapper">
          {isMobile && (
            <div onClick={chatClickHandler} onKeyDown={chatClickHandler} role="button" tabIndex={0} className="icon-wrapper">
              {chatIcon}
            </div>
          )}
          ...
          {isMobile && (
            <div onClick={navClickHandler} onKeyDown={navClickHandler} role="button" tabIndex={0} className="hamburger-icon-wrapper">
