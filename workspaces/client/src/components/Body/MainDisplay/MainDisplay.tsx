...
import PlayerQueueSection from './PlayerQueueSection/PlayerQueueSection';
import PlayGameButton from './ControlsSection/PlayGameButton/PlayGameButton';
...
const MainDisplay: React.FC = () => {
  ...
  return (
    <section id="main-display">
      <section id="main-display__top-section">
        <VideoFeedSection />
      </section>
      <SidebarNavigation tabs={authState.state.isAuthenticated ? LOGGED_IN_TABS : LOGGED_OUT_TABS} />
      <section id="main-display__bottom-section">
