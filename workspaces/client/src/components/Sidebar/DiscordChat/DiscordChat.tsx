...
const DiscordChat: React.FC = () => {
	...
	const discordLink = (
		<div className="link-wrapper">
			<a
				href="https://discord.com/channels/785224675135455242/785224675135455245"
				target="_blank"
				rel="noreferrer"
			>
				discord.gg/fukuTV
...
// {state.isAuthenticated && <UserProfile isSignedIn={state.isAuthenticated} />}
// {!state.isAuthenticated && <LoggedOut isSignedIn={state.isAuthenticated}
// setIsSignedIn={actions.loginWithPopup} />}
