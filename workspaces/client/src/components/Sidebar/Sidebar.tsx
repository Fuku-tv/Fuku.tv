...
import SidebarNavigation from '../Main/Navigation/Navigation';
import './Sidebar.scss';
...
const SideBar: React.FC = () => {
	...
	const loggedOut = <LoggedOut isSignedIn={state.isAuthenticated} setIsSignedIn={actions.loginWithPopup} />;
