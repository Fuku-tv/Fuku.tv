...
tape('_getSignedRequest', (t) => {
  ...
  t.equal(
    signedRequest.host,
    process.env.NODE_ENV === 'production' ? 'agcod-v2.amazon.com' : 'agcod-v2-gamma.amazon.com',
    `signedRequest.host in ${process.env.NODE_ENV} is correct`
  );
